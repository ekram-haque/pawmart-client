      ...
      <MyContainer>
        <div className="navbar">
          ...
          <div className="navbar-end flex items-center gap-4">
            ...
            {/* Login Button */}
            <MyLink to={'/login'} className="px-5 py-2 bg-gradient-to-r from-purple-50 to-pink-50 dark:from-purple-800 dark:to-pink-700 rounded-md font-semibold hover:opacity-70 transition duration-300 shadow-md">
              Login
            </MyLink>
          </div>
        </div>
