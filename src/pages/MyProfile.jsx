...
export default function MyProfile() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-50 to-blue-100 py-10 px-4 flex flex-col items-center">
      {/* Profile Card */}
      <div className="bg-white w-full max-w-3xl rounded-2xl shadow-lg p-6 flex flex-col items-center">
        <img
